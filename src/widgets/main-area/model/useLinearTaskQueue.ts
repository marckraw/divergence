...
import type { RightPanelTab } from "../ui/MainArea.types";
import {
...
import type { WorkspaceMember } from "../../../entities";

interface UseLinearTaskQueueParams {
...
export function useLinearTaskQueue({
  activeSession,
  appSettings,
  projects,
  ...
  }, [linearIssues, onSendPromptToSession, activePaneSessionIdRef]);
