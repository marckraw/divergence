...
import { resolveProjectForNewDivergence } from "./appSelection.pure";

const projectA: Project = { id: 1, name: "A", path: "/a", createdAt: "2026-01-01" };
const projectB: Project = { id: 2, name: "B", path: "/b", createdAt: "2026-01-01" };
